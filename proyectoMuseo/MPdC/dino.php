...
<body>
    ...
    <header class="header">
        <?php
            ...
            $sql="SELECT `nombre`, `banner` FROM `muestras` WHERE `id_muestra`=1;"; //Se realiza el SQL de tipo SELECT y se seleccionan los campos nombre y banner de la tabla muestras cuando el id_muestra sea 4
    ...
    <script>
        ...
        let audio = new Audio('sounds/dino.mp3'); //Se crea la variable audio y se crea el objeto Audio 
