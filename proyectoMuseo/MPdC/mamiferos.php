...
<body>
    ...
    <header class="header">
       ...
       $sql="SELECT `nombre`, `banner` FROM `muestras` WHERE `id_muestra`=2;"; //Se realiza el SQL de tipo SELECT y se seleccionan los campos nombre y banner de la tabla muestras cuando el id_muestra sea 2
    ...
    <main class="main">
        ...
        <?php
            ...
            $sql="SELECT `descripcion`, `img` FROM `muestras` WHERE `id_muestra`=2;"; //Se realiza la segunda consulta SQL, en este caso un SELECT y se selecciona los campos descripcion e img de la tabla muestras cuanod el  id_muestra sea 2 (Mamiferos)
            $result = mysqli_query($con,$sql); //Se almacena el resultado de la consulta en la variable $result
    ...
    <script>
        ...
        let audio = new Audio('sounds/mamiferos.mp3'); //Se crea la variable audio y se crea el objeto Audio 
