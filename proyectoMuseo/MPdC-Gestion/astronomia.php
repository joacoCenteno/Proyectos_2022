...
<body>
    ...
    <main class="main">
        ...
        <?php
            ...
            if(isset($_POST['btnGuardar'])){ //Se verifica que exista la vatiable POST con el name btnGuardar
                ...
                $firstsql ="UPDATE `muestras` SET `descripcion`='$newText' WHERE `id_muestra` = 4;"; //Se realiza la primera consulta SQl UPDATE y se actualiza el campo descripcion de la tabla muestras cuando el id_muestra sea 4 (Astronomia)
    ...
    var audio = new Audio('sounds/astronomia.mp3');
    audio.play();
